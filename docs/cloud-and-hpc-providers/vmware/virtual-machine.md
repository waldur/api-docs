...
=== "Python"
    ...
    from waldur_api_client.models.vmware_virtual_machine_field_enum import VmwareVirtualMachineFieldEnum # (2)
    from waldur_api_client.api.vmware_virtual_machine import vmware_virtual_machine_list # (3)
    ...
    2.  **Model Source:** [`VmwareVirtualMachineFieldEnum`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/vmware_virtual_machine_field_enum.py)
    3.  **API Source:** [`vmware_virtual_machine_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/vmware_virtual_machine/vmware_virtual_machine_list.py)
...
=== "Python"
    ...
    ```python
    from waldur_api_client.client import AuthenticatedClient
    from waldur_api_client.models.vmware_virtual_machine_field_enum import VmwareVirtualMachineFieldEnum # (1)
    from waldur_api_client.api.vmware_virtual_machine import vmware_virtual_machine_retrieve # (2)
    ...
    1.  **Model Source:** [`VmwareVirtualMachineFieldEnum`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/vmware_virtual_machine_field_enum.py)
    2.  **API Source:** [`vmware_virtual_machine_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/vmware_virtual_machine/vmware_virtual_machine_retrieve.py)
