...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/openstack-ports/` | [List ports](#list-ports) |
| <span class="http-badge http-get">GET</span> | `/api/openstack-ports/{uuid}/` | [Get port details](#get-port-details) |
| <span class="http-badge http-post">POST</span> | `/api/openstack-ports/` | [Create port](#create-port) |
...
| <span class="http-badge http-post">POST</span> | `/api/openstack-ports/{uuid}/update_security_groups/` | [Update port security groups](#update-port-security-groups) |
| <span class="http-badge http-put">PUT</span> | `/api/openstack-ports/{uuid}/` | [Update port](#update-port) |
| <span class="http-badge http-patch">PATCH</span> | `/api/openstack-ports/{uuid}/` | [Partially update port](#partially-update-port) |
| <span class="http-badge http-delete">DELETE</span> | `/api/openstack-ports/{uuid}/` | [Delete port](#delete-port) |
| **Other Actions** | | |
