...
=== "Python"
    ...
    2.  **API Source:** [`openstack_instances_set_erred`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/openstack_instances/openstack_instances_set_erred.py)
...
=== "Python"
    ...
    1.  **API Source:** [`openstack_instances_set_ok`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/openstack_instances/openstack_instances_set_ok.py)
