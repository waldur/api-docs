...
| <span class="http-badge http-get">GET</span> | `/api/maintenance-announcements/{uuid}/` | [Retrieve a maintenance announcement](#retrieve-a-maintenance-announcement) |
| <span class="http-badge http-post">POST</span> | `/api/maintenance-announcements/` | [Create a maintenance announcement](#create-a-maintenance-announcement) |
| <span class="http-badge http-put">PUT</span> | `/api/maintenance-announcements/{uuid}/` | [Update a maintenance announcement](#update-a-maintenance-announcement) |
