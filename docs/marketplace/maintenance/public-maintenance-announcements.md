...
=== "Python"
    ...
    from waldur_api_client.api.public_maintenance_announcements import public_maintenance_announcements_list # (3)
    ...
    3.  **API Source:** [`public_maintenance_announcements_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/public_maintenance_announcements/public_maintenance_announcements_list.py)
