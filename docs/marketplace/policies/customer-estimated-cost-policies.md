...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-customer-estimated-cost-policies/` | [List Marketplace Customer Estimated Cost Policies](#list-marketplace-customer-estimated-cost-policies) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-customer-estimated-cost-policies/{uuid}/` | [Retrieve](#retrieve) |
| <span class="http-badge http-post">POST</span> | `/api/marketplace-customer-estimated-cost-policies/` | [Create](#create) |
| <span class="http-badge http-put">PUT</span> | `/api/marketplace-customer-estimated-cost-policies/{uuid}/` | [Update](#update) |
| <span class="http-badge http-patch">PATCH</span> | `/api/marketplace-customer-estimated-cost-policies/{uuid}/` | [Partial Update](#partial-update) |
| <span class="http-badge http-delete">DELETE</span> | `/api/marketplace-customer-estimated-cost-policies/{uuid}/` | [Delete](#delete) |
| **Other Actions** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-customer-estimated-cost-policies/actions/` | [List Marketplace Customer Estimated Cost Policies Actions](#list-marketplace-customer-estimated-cost-policies-actions) |
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_customer_estimated_cost_policies_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_customer_estimated_cost_policies_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_retrieve.py)
...
=== "Python"
    ...
    1.  **Model Source:** [`CustomerEstimatedCostPolicyRequest`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/customer_estimated_cost_policy_request.py)
    2.  **API Source:** [`marketplace_customer_estimated_cost_policies_create`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_create.py)
...
=== "Python"
    ...
    1.  **Model Source:** [`CustomerEstimatedCostPolicyRequest`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/customer_estimated_cost_policy_request.py)
    2.  **API Source:** [`marketplace_customer_estimated_cost_policies_update`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_update.py)
...
=== "Python"
    ...
    1.  **Model Source:** [`PatchedCustomerEstimatedCostPolicyRequest`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/patched_customer_estimated_cost_policy_request.py)
    2.  **API Source:** [`marketplace_customer_estimated_cost_policies_partial_update`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_partial_update.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_customer_estimated_cost_policies_destroy`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_destroy.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_customer_estimated_cost_policies_actions_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_estimated_cost_policies/marketplace_customer_estimated_cost_policies_actions_retrieve.py)
