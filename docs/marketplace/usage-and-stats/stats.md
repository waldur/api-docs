...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-stats/aggregated_usage_trends/` | [Return aggregated usage trends per month](#return-aggregated-usage-trends-per-month) |
...
| <span class="http-badge http-get">GET</span> | `/api/marketplace-stats/resource_usage_by_organization_type/` | [Return component usages grouped by project members' organization type](#return-component-usages-grouped-by-project-members-organization-type) |
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_aggregated_usage_trends_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_aggregated_usage_trends_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_customer_member_summary_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_customer_member_summary_retrieve.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_offering_costs_summary_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_offering_costs_summary_retrieve.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_project_classification_summary_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_project_classification_summary_retrieve.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_resource_usage_by_creator_affiliation_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_resource_usage_by_creator_affiliation_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_resource_usage_by_customer_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_resource_usage_by_customer_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_resource_usage_by_organization_type_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_resource_usage_by_organization_type_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_resources_geography_summary_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_resources_geography_summary_retrieve.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_user_job_title_count_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_user_job_title_count_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_stats_user_organization_type_count_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_stats/marketplace_stats_user_organization_type_count_list.py)
