...
|:--- |:--- |:--- |
| **Core CRUD** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-public-offerings/` | [List public offerings](#list-public-offerings) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-public-offerings/{uuid}/` | [Retrieve a public offering](#retrieve-a-public-offering) |
| **Other Actions** | | |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-public-offerings/{uuid}/plans/` | [List plans for an offering](#list-plans-for-an-offering) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-public-offerings/{uuid}/plans/{plan_uuid}/` | [Retrieve a specific plan for an offering](#retrieve-a-specific-plan-for-an-offering) |
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_public_offerings_plans_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_public_offerings/marketplace_public_offerings_plans_list.py)
...
=== "Python"
    ...
    1.  **API Source:** [`marketplace_public_offerings_plans_retrieve`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_public_offerings/marketplace_public_offerings_plans_retrieve.py)
