...
|:--- |:--- |:--- |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-plan-components/` | [List plan components](#list-plan-components) |
| <span class="http-badge http-get">GET</span> | `/api/marketplace-plan-components/{id}/` | [Retrieve a plan component](#retrieve-a-plan-component) |
