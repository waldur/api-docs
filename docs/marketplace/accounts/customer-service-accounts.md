...
=== "Python"
    ...
    from waldur_api_client.api.marketplace_customer_service_accounts import marketplace_customer_service_accounts_list # (2)
    ...
    2.  **API Source:** [`marketplace_customer_service_accounts_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/marketplace_customer_service_accounts/marketplace_customer_service_accounts_list.py)
