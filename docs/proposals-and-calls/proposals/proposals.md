...
| **Permissions & Users** | | |
| <span class="http-badge http-get">GET</span> | `/api/proposal-proposals/{uuid}/list_users/` | [List users and their roles in a scope](#list-users-and-their-roles-in-a-scope) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-proposals/{uuid}/add_user/` | [Grant a role to a user](#grant-a-role-to-a-user) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-proposals/{uuid}/delete_user/` | [Revoke a role from a user](#revoke-a-role-from-a-user) |
| <span class="http-badge http-post">POST</span> | `/api/proposal-proposals/{uuid}/update_user/` | [Update a user's role expiration](#update-a-users-role-expiration) |
| **Other Actions** | | |
...
=== "Python"
    ...
    1.  **Model Source:** [`ProposalDetachDocumentsRequest`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/proposal_detach_documents_request.py)
    2.  **API Source:** [`proposal_proposals_detach_documents`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/proposal_proposals/proposal_proposals_detach_documents.py)
