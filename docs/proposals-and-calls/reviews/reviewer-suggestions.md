...
=== "Python"
    ...
    1.  **Model Source:** [`ReviewerSuggestionOEnum`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/reviewer_suggestion_o_enum.py)
    2.  **Model Source:** [`ReviewerSuggestionStatusEnum`](https://github.com/waldur/py-client/blob/main/waldur_api_client/models/reviewer_suggestion_status_enum.py)
    3.  **API Source:** [`reviewer_suggestions_list`](https://github.com/waldur/py-client/blob/main/waldur_api_client/api/reviewer_suggestions/reviewer_suggestions_list.py)
