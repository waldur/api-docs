...
=== "Responses"
    ...
    **`200`** - 
    ...
    | `abstract` | string |  |
    | `coauthors` | array of anys | List of co-author names and identifiers |
...
=== "Responses"
    ...
    **`200`** - 
    ...
    | `alternative_names` | array of strings | List of name variants used in publications |
    ...
    | `publications.coauthors` | array of anys | List of co-author names and identifiers |
